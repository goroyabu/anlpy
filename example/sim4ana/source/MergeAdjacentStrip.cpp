...
MergeAdjacentStrip::MergeAdjacentStrip()
    : anl::VANL_Module("MergeAdjacentStrip", "0.1")
{
...
int MergeAdjacentStrip::mod_bgnrun()
{
...
int MergeAdjacentStrip::mod_ana()
{
...
int MergeAdjacentStrip::mod_endrun()
{
