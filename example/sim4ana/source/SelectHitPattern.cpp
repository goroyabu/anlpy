...
SelectHitPattern::SelectHitPattern()
    : anl::VANL_Module("SelectHitPattern", "0.1")
{
...
int SelectHitPattern::mod_bgnrun()
{
...
int SelectHitPattern::mod_endrun()
{
