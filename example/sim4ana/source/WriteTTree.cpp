...
anl::WriteTTree::WriteTTree()
    : anl::VANL_Module("WriteTTree", "1.0")
{
...
int anl::WriteTTree::mod_bgnrun()
{
    ...
    cout << file_name << " is newly opened." << endl;
    ...
    cout << tree_name << " is generated." << endl;
...
int anl::WriteTTree::switch_branch(const std::string& selection, const std::string& delim, bool enable)
{
...
std::string anl::WriteTTree::replace_all
...
std::string anl::WriteTTree::convert_regex(std::string wildcard)
{
...
int anl::WriteTTree::write_all_branch()
{
	...
	if ( type == "int" ) {
	    ...
	    auto leaflist = key+"/C";
	    output_tree->Branch( key.c_str(),
				 bnk::getvecptr<std::string>(key)->data(),
				 leaflist.c_str() );	    
	    cout << setw(25) << type << " " << setw(25) << key << endl;
	}
	else {
	    cerr << "*Warning* in WriteTTree : ";
	    cerr << " Branch of " << type << " " << key;
...
bool anl::WriteTTree::is_disabled(const std::string& key)
{
