...
CutReadoutThreshold::CutReadoutThreshold()
    : anl::VANL_Module("CutReadoutThreshold", "0.1")
{
...
int CutReadoutThreshold::mod_bgnrun()
{
...
int CutReadoutThreshold::mod_ana()
{
...
int CutReadoutThreshold::mod_endrun()
{
